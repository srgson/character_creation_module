...
def attack(char_name: str, char_class: str) -> str:
    """
    Return message about amount of damage
    based on class of your character.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """
    Return message about amount of blocked damage
    based on class of your character.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    Return message about special move
    based on class of your character.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Return class of character based on player's choice."""
    approve_choice = None
    char_class = None
